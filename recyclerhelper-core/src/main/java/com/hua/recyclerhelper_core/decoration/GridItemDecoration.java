...
import com.hua.recyclerhelper_core.R;
...
public class GridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridItemDecoration setDividerColor(@ColorInt int color, int dividerHeight) {
        this.setDividerDrawable(new ColorDrawable(color));
        this.dividerHeight = dividerHeight;
        return this;
    }

    public GridItemDecoration setDividerHeight(int dividerHeight) {
        this.dividerHeight = dividerHeight;
        return this;
    }
     ...
     */
    public void setDividerDrawable(@NonNull Drawable drawable) {
        mDivider = drawable;
